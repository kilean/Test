...
<body>
    <!--HTML-->
    <audio id="audio">
        <source id="s" src="Music/Another realm.mp3" type="audio/mpeg" title="Little Hoot Theme Song" />
    </audio>
    <div id="conPanel">
        <select id="music">
            ...
            <option value="Music/Sundial Dreams.mp3">Sundial Dreams</option>
            <option value="Music/The Enchanted Garden.mp3">The Enchanted Garden</option>
            <option value="Music/The Purple Butterfly.mp3">The Purple Butterfly</option>
			<option value="Music/Through The Arbor.mp3">Through The Arbor</option>
			<option value="Music/Water Lilies.mp3">Water Lilies</option>
        </select>
